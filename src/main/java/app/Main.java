...
public final class Main {
    ...
    /**
     * Return true if LINE is an Enigma configuration line.
     */
    ...
    public static void configure(Machine M, String config) {
        ...
        Reflector reflector = getReflectorFromString(cArray[1]);
        Rotor left = getRotorFromString(cArray[2]);
        Rotor middle = getRotorFromString(cArray[3]);
        Rotor right = getRotorFromString(cArray[4]);
        String setting = cArray[5];
